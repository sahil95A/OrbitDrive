...
public class KafkaConfig {
    ...
    @Bean
    public ProducerFactory<String, String> producerFactory() { // tells how kafkatemp is created
    ...
    public ConsumerFactory<String, String> consumerFactory() {
        ...
        props.put(
                ...
                "sample-group-2  ");
        props.put(
                ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, //consumer deserialize the data
